...
namespace PzG {
  ...
  * \retval false - w przypadku przeciwnym.
  */
  bool LaczeDoGNUPlota::DeleteFileName(
		       const char          *sNazwaPliku,
		       TypDostepuDoZasobu   Dostep
		     )
  {
...
*/
 ...
 InfoPlikuDoRysowania&  LaczeDoGNUPlota::AddFilename(
                                  ...
                                  )
 {
  ...
  InfoPlikuDoRysowania Info(NazwaPliku,LS_CONTINUOUS,DOMYSLNA_SZEROKOSC,Color);
 ...
 */
 ...
 {
     return AddFilename(NazwaPliku,SprawdzIstnienie,Dostep)
            .ZmienSposobRys(LS_CONTINUOUS);
 }
 ...
 */
 ...
 {
  switch (_TrybRys) {
   case DM_2D: BudujPreambule_2D(Preambula); break;
   case DM_3D: BudujPreambule_3D(Preambula); break;
  }
 }
